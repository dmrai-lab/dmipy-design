...
# SequenceTiming + encoding_spectrum moved to the JAX-free `timing` module (shared by the
# NOW SQP solver and this differentiable AL solver); re-exported here for back-compat.
from .timing import encoding_spectrum, SequenceTiming  # noqa: E402,F401
